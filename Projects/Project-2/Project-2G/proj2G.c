...
int main() {
    ...
    // TODO: Fix this code so that it prints the array elements using array syntax
    printf("Array elements: ");
    for (int i = 0; i < 5; i++) {
        // Error: Missing [i] at the end of arr:
        printf("%d ", arr[i]);
    }
    printf("\n");

    // Accessing array elements using the pointer syntax
    // TODO: Fix this code so that it prints the array elements using pointer syntax
    printf("Pointer elements: ");
    for (int i = 0; i < 5; i++) {
        // Error: Missing [i] at the end of ptr:
        printf("%d ", ptr[i]);
    }
    printf("\n");

    // Changing array elements using the array syntax
    // TODO: Fix this code so that it changes the third array element to 10 using array syntax
    // Error: Missing [2] at the end of arr:
    arr[2] = 10;
    ...
    // TODO: Fix this code so that it changes the fifth array element to 20 using pointer syntax and pointer arithmetic
    // Error: Missing [4] at the end of ptr and extra (*):
    ptr[4] = 20;
    ...
    // TODO: Fix this code so that it allocates an array of 10 ints using malloc and then prints the array elements using pointer syntax
    // Error: Made ptr2 a memory array instead of int *ptr2:
...
// TODO: Fix this function so that it returns a pointer to a dynamic array not a pointer to a stack array
char *get_name(void) {
    // Error: Made name a dynamic array instead of int char[200]:
